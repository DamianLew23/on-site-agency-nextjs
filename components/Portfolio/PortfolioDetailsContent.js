...
const images = [
  "/images/portfolio/poradyzakupowe/portfolio1.jpg",
  "/images/portfolio/poradyzakupowe/portfolio2.jpg",
  "/images/portfolio/poradyzakupowe/portfolio3.jpg",
  "/images/portfolio/poradyzakupowe/portfolio4.jpg",
  "/images/portfolio/poradyzakupowe/portfolio5.jpg",
];
            ...
            <div className="row m-0">
              <div className="col-lg-4 col-md-6 p-0">
                <div className="portfolio-details-image">
                  <img
                    src="/images/portfolio/poradyzakupowe/portfolio1.jpg"
                    alt="image"
                  />
                ...
                <div className="portfolio-details-image">
                  <img
                    src="/images/portfolio/poradyzakupowe/portfolio2.jpg"
                    alt="image"
                  />
              ...
              <div className="col-lg-4 col-md-6 p-0">
                <div className="portfolio-details-image">
                  <img
                    src="/images/portfolio/poradyzakupowe/portfolio3.jpg"
                    alt="image"
                  />
              ...
              <div className="col-lg-4 col-md-12 p-0">
                <div className="row">
                  <div className="col-lg-12 col-md-6 pr_0">
                    <div className="portfolio-details-image">
                      <img
                        src="/images/portfolio/poradyzakupowe/portfolio4.jpg"
                        alt="image"
                      />
                  ...
                  <div className="col-lg-12 col-md-6 pl_0">
                    <div className="portfolio-details-image">
                      <img
                        src="/images/portfolio/poradyzakupowe/portfolio5.jpg"
                        alt="image"
                      />
